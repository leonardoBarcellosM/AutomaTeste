...
namespace AutomacaoFuncional.tests.utils
{
    class CamundaApi
    {
        ...
        static string getInstance = "http://dev-camunda.fundacred.org.br:8080/engine-rest/process-instance/?businessKey=";
        static string deleteInstance = "http://dev-camunda.fundacred.org.br:8080/engine-rest/process-instance/";
        static string getVariables = "http://dev-camunda.fundacred.org.br:8080/engine-rest/process-instance/";
        static string getProcess = "http://dev-camunda.fundacred.org.br:8080/engine-rest/task?processInstanceBusinessKey=";
